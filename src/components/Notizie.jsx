          ...
          <Col lg={3}>
            ...
            <Card className="mt-2 p-3">
              <Card.Text className="d-flex border-bottom pb-2">
                <div>
                  <span className="fw-semibold left-side-bar-home  m-0"> Collegamenti</span>
                  <span className="m-0 left-side-bar-home text-secondary">Espandi la tua rete</span>
                </div>
              </Card.Text>
              <Card.Text>
                <div className="d-flex ">
                  <BookmarkFill />
                  <span className="fw-semibold left-side-bar-home  m-0 ms-2 mb-3"> Elementi salvati</span>
                </div>
                <div className="d-flex ">
                  <PeopleFill />
                  <span className="fw-semibold left-side-bar-home  m-0 ms-2 mb-3"> Gruppi</span>
                </div>

                <div className="d-flex ">
                  <Calendar2Event />
                  <span className="fw-semibold left-side-bar-home  m-0 ms-2"> Eventi</span>
                </div>
              </Card.Text>
            </Card>
          </Col>
