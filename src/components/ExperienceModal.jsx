...
import { Modal, Button, Container, Row, Form, FormSelect, FormCheck, FormGroup } from "react-bootstrap";
              ...
              <div id="ContainerScrollBar">
                ...
                <div className="ps-4 pe-4 pt-2 pb-2">
                    ...
                    {["checkbox"].map((type) => (
                      <div key={`default-${type}`} className="mb-3">
                        <FormCheck
                          ...
                          checked={formValue.attualmenteLavoro}
                          onChange={(e) => {
                            setFormValue({
                              ...formValue,
                  ...
                  <Row className="form-select-container mb-4">
                    ...
                    <div className="form-select1">
                      <select
                        ...
                        value={formValue.dataInizioMese}
                        onChange={(e) => {
                          setFormValue({
                            ...formValue,
                    ...
                    <div className="form-select1">
                      <select
                        className="form-select form-select-sm col-6"
                        aria-label="Small select example"
                        value={formValue.dataInizioAnno}
                        onChange={(e) => {
                          setFormValue({
                            ...formValue,
                  ...
                  <div className="mt-4">
                    ...
                    {!competenzeInput && (
                      <button onClick={() => setCompetenzeInput(true)} className="btnCompetenze">
                        <svg width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <g id="Complete">
                            <g data-name="add" id="add-2">
                              <g>
                                <line fill="#0066CC" stroke="#0066CC" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="12" x2="12" y1="19" y2="5" />
                                <line fill="#0066CC" stroke="#0066CC" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="5" x2="19" y1="12" y2="12" />
                              </g>
                            </g>
                          </g>
                        </svg>
                  ...
                  <div>
                    ...
                    {!mediaInput && (
                      <button onClick={() => setMediaInput(true)} className="btnCompetenze">
                        <svg width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <title />
                      ...
                      <div className="containerDrop mt-2">
                        ...
                        <div className="contenitoreDropDown2">
                          <div className="svgDropDown2">
                            <svg fill="#000000" width="30px" height="30px" viewBox="0 0 36 36" version="1.1" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
